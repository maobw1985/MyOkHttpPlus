...
public class MyOkHttpPlusConfiguration {
    ...
    private MyOkHttpPlusConfiguration(Builder builder) {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setCommenParams(Map<String,String> params){
        ...
        public MyOkHttpPlusConfiguration build() {
            return new MyOkHttpPlusConfiguration(this);
        }
    }
